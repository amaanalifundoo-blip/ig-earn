...
if (tg) {
  ...
  // Telegram theme ke saath compatible
  try {
    tg.setHeaderColor('#f3f5ff');
...
app.innerHTML = `
  <main class="app-shell">
    ...
    <section class="greeting-card">
      ...
      <button class="header-arrow" aria-label="Open profile">
        ›
      </button>
    </section>
    ...
    <section class="balance-card">
      ...
      <div class="wallet-icon" aria-hidden="true">
        <svg viewBox="0 0 48 48">
          <path d="M8 14.5C8 11.5 10.5 9 13.5 9H37"
                fill="none"
                stroke="currentColor"
                stroke-width="2.6"
                stroke-linecap="round"/>

          <path d="M8 14.5V35c0 2.8 2.2 5 5 5h25c1.7 0 3-1.3 3-3V16c0-1.7-1.3-3-3-3H13.5"
                fill="none"
                stroke="currentColor"
                stroke-width="2.6"
                stroke-linecap="round"/>

          <path d="M31 22h8v8h-8c-2.2 0-4-1.8-4-4s1.8-4 4-4Z"
                fill="none"
                stroke="currentColor"
                stroke-width="2.6"/>

          <circle cx="31.5" cy="26" r="1.3" fill="currentColor"/>
        </svg>
      </div>
    ...
    <section class="action-grid">
      ...
      <button class="action-card" data-page="submit">
        ...
        <span class="action-title">Submit Proof</span>
      </button>
      ...
      <button class="action-card" data-page="tasks">
        ...
        <span class="action-title">My Tasks</span>
      </button>
      ...
      <button class="action-card" data-page="referral">
        ...
        <span class="action-title">Refer & Earn</span>
      </button>
    ...
    <!-- Referral Banner -->
    <button class="referral-card" data-page="referral">
    ...
    <nav class="bottom-nav">
      ...
      <button class="nav-item" data-nav="wallet">
        <span class="nav-icon">₹</span>
        <span>Wallet</span>
      </button>
